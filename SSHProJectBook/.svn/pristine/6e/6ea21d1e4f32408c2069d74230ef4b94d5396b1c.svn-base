											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/book_findByPages.action"
														target=main>－ 图书信息查询</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/reader_findByPages.action"
														target=main>－读者信息查询</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/lend_findByPages.action"
														target=main>－借阅记录查询</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
									...
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/money_findByPages.action"
														target=main>－罚款记录查询</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
