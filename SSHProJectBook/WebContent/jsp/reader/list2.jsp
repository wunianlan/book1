...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/reader_findByPages.action" method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${reader.state }</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/reader_initUpdate.action?sid=${reader.sid}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/reader_delete.action?sid=${reader.sid}" onclick="return window.confirm('确认删除吗?')">删除</a>
													</TD>
												</TR>
												</c:forEach>
											</TBODY>
